function [ xf, yf, tf, MUf, MVf  ] = FiniteDiffShnakenberg( xmin, xmax, Nx, ymin, ymax, Ny , T, Nt, u_in, v_in, u_L, u_R, u_T, u_B, v_L, v_R, v_T, v_B)
...
for n = 1:Nt
    % Calculaation
    U1 = U0 + dt*gamma*F_Schnakenberg(U0,V0,a) - dt*A*U0 ;
    V1 = V0 + dt*gamma*G_Schnakenberg(U0,V0,b) - dt*d*A*V0 ;
    % Storage
    MUf(2:Nx+1, 2:Ny+1, n+1 ) = reshape(U0, Nx, Ny);
    MVf(2:Nx+1, 2:Ny+1, n+1 ) = reshape(V0, Nx, Ny);
